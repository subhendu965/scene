...
if(isset($_SESSION)){
 ...
 if(isset($_SESSION['hb_captcha']['selected_captcha']) && $_SESSION['hb_captcha']['selected_captcha']=="smowtxt8g5Mo3k"){
    ...
    $selected_captcha_generator="/captcha/simple_one_word_text/simpleText_m1.php";

    if(isset($_POST['token']) && $_POST['token']=="ref632d"){
      echo "Done:";
      $selected_captcha_generator="/captcha/simple_one_word_text/simpleText_m1.php?t=".rand(0,6000);
    }
?>
<style>
  #captcha_main_div{
...
/********************************************************************************************************************/
  ...
  function captcha_simple_text_refresh(){
    ...
    url="token=ref632d";
    captcha_refresh_request.open("POST","/captcha/simple_one_word_text/simple_one_word_text.php",true);
  ...
  function captcha_simple_text_verify(){
    ...
    captcha_verify_request.open("POST","/captcha/verify.php",true);
