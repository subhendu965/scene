...
if($hb_user_logged_in){
	$query="SELECT sl,username FROM hb_scene_pages WHERE username='".$_SESSION['hb_user']['username']."'";
...
function ajax_complete_handler(e){
	...
	if(e.target.responseText.substr(0,4)=="Done"){
		...
		document.querySelector("#show_image_div_2587 img").src="/user_gallery/<?php echo  "user_".$_SESSION['hb_user']['username'] ?>/"+filename;
		document.querySelector("#error_message_457k").style.transform="scale(1,0)";
